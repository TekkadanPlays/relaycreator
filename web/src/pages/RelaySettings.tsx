    ...
    <div className="space-y-6 animate-in">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="font-mono text-sm text-muted-foreground">wss://{relay.name}.{relay.domain}</p>
          </div>
        </div>
      ...
      <Tabs defaultValue="profile" className="space-y-6">
        <TabsList className="grid w-full grid-cols-3 lg:grid-cols-6 h-auto">
          <TabsTrigger value="profile" className="gap-1.5 py-2"><Globe className="size-3.5 hidden sm:block" /> Profile</TabsTrigger>
          <TabsTrigger value="access" className="gap-1.5 py-2"><Shield className="size-3.5 hidden sm:block" /> Access</TabsTrigger>
          <TabsTrigger value="moderators" className="gap-1.5 py-2"><Users className="size-3.5 hidden sm:block" /> Team</TabsTrigger>
          <TabsTrigger value="streams" className="gap-1.5 py-2"><Radio className="size-3.5 hidden sm:block" /> Streams</TabsTrigger>
          <TabsTrigger value="payments" className="gap-1.5 py-2"><Zap className="size-3.5 hidden sm:block" /> Payments</TabsTrigger>
          <TabsTrigger value="danger" className="gap-1.5 py-2"><Trash2 className="size-3.5 hidden sm:block" /> Danger</TabsTrigger>
        </TabsList>
    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          />
          {bannerImage && (
            <div className="mt-2 h-32 overflow-hidden rounded-lg border border-border/50">
    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="flex items-center justify-between rounded-lg border border-border/50 p-4">
            <div>
              <p className="font-medium">{allow ? "Allow by default" : "Block by default"}</p>
          ...
          <div className="flex items-center justify-between rounded-lg border border-border/50 p-4">
            <div>
              <p className="font-medium">Authentication (NIP-42)</p>
          ...
          <div className="flex items-center justify-between rounded-lg border border-border/50 p-4">
            <div>
              <p className="font-medium">Allow Tagged Events</p>
      ...
      <CardContent className="space-y-3">
        ...
        {items.length === 0 ? (
          ...
          <div className="space-y-1.5 max-h-64 overflow-y-auto">
            {items.map((item) => (
              <div key={item.id} className="flex items-center gap-2 rounded-lg border border-border/50 px-3 py-2">
                {icon}
        ...
        {relay.streams.length === 0 ? (
          ...
          <div className="space-y-2">
            {relay.streams.map((stream) => (
              <div key={stream.id} className="flex items-center gap-3 rounded-lg border border-border/50 p-3">
                ...
                <Badge variant="secondary">{stream.status || "pending"}</Badge>
