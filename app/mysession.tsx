...
export default function ShowSession() {
    ...
    return (
        <div className="font-terminus font-smooth-never font-smooth-never navbar bg-base-100 flex">
            {showLoginHelp && (
                <dialog
                    id="my_modal_5"
            ...
            <div className="flex-1">
                <a
                    href={rootDomain + "/"}
                    className="btn btn-ghost normal-case text-2xl font-terminus font-smooth-never"
                >
                    mycelium.social
                </a>
            </div>
