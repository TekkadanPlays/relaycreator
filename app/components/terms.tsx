...
export default function Terms(
    ...
    return (
        <div>
            ...
            {showTerms &&
                <div>
                    <p className="text-base">This Terms of Sevice applies to all relays hosted by relay.tools.</p>
                    ...
                    <p className="text-base">By connecting to this relay, you agree to the following:</p>
